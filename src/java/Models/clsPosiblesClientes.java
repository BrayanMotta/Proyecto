...
public class clsPosiblesClientes {
    ...
    public clsFPC getObclsFPC() {
        return obclsFPC;
    }

    public void setObclsFPC(clsFPC obclsFPC) {
        this.obclsFPC = obclsFPC;
    }

    public clsEPC getObclsEPC() {
        return obclsEPC;
    }

    public void setObclsEPC(clsEPC obclsEPC) {
        this.obclsEPC = obclsEPC;
    }
    ...
    public String getStCorreoSecundario() {
        return stCorreoSecundario;
    }

    public void setStCorreoSecundario(String stCorreoSecundario) {
        this.stCorreoSecundario = stCorreoSecundario;
    }
}
